...
BasicMaths:find alpha {
  ...
  print("alpha greater than %0.f is %d (1:tr, 0:fls)\n", 2, alpha > 2);
  print(
    "alpha greater than or equal to %0.f is %d (1:tr, 0:fls)\n",
    2, alpha >= 2);

  print("alpha less than %0.f is %d (1:tr, 0:fls)\n", 2, alpha < 2);
  print(
    "alpha less than or equal to %0.f is %d (1:tr, 0:fls)\n",
    2, alpha <= 2);
